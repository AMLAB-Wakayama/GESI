...
%
%
%DirGCFB = [DirRoot '../GCFBv234/'];  % normal install
% DirGCFB = [DirRoot '../../../GitHub_Public/gammachirp-filterbank/GCFBv234/'];  % local use only
DirGCFB = [DirRoot '../gammachirp-filterbank/GCFBv234/'];  %  local use only
...
for nSnd =  1:length(SNRList)
   ...
   if fs ~= fs2  %  IT
    ...
    %%%%%%%%%%%%%%%%%%%%%%
    [Result, GESIparam] = GESIv149(SndRef, SndTest, GCparam, GESIparam); % v149
